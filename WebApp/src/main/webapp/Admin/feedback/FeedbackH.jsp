...
<script type="text/javascript">
	function display() 
	{
		...
		ob.open("GET","getfeedback.jsp?email="+s);
		ob.send();
	...
	{
		ob=new XMLHttpRequest();
		ob.open("GET","displayallfeedback.jsp");
		ob.send();
		ob.onreadystatechange=function()
		{
			if(ob.status==200 && ob.readyState==4)
...
<div style="padding-top:50px">
	<div  class="container" align="center">
		<div class="mb-3">
    	<label for="exampleInputEmail1" class="form-label"><h4>Search<span style="color:red"> Feedback</span></h4></label>
